...
public class CommonUtils {
  ...
  public static synchronized String getSystemEnvProperty(
      final String keyName, final String defaultValue) {
  ...
  public static synchronized String getAppCollectionName(final String appName) {
    return "app_" + appName;
  }
}
